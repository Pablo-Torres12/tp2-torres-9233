...
![Ejecución pdf_version](img/cap_pdf_version.png)

### 2. Script: Organizador (`organizador.sh`)
![Ejecución organizador](img/cap_organizador.png)

### 3. Menú Interactivo (`monitorear.sh`)
![Menú Interactivo](img/cap_monitorear.png)
...
![Ejecución Backup](img/cap_backup_manager.png)
